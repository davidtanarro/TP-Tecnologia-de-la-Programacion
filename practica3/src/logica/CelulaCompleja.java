...
public class CelulaCompleja implements Celula {
	/**
	 * Atributo privado que indica el número de células que le quedan por comer a la célula actual.
	 */
	private int comidas;
	...
	public void leerCelula(File fichero, Scanner s) {
		setComidas(new Integer(s.nextInt()));	// Guardamos la linea en un Int
	}
	@Override
	public void escribirSuperficie(FileWriter fichero) throws IOException {
		fichero.write(getComidas() + "");
