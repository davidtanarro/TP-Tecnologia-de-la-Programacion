...
public class CelulaSimple implements Celula {
	...
	@Override
	public void leerCelula(File fichero, Scanner s) {
		setPasosNoMovidos(new Integer (s.nextInt())); 		// Guardamos la linea en un Int
		setPasosDados(new Integer (s.nextInt())); 			// Guardamos la linea en un Int
	}
	@Override
	public void escribirSuperficie(FileWriter fichero) throws IOException {
		fichero.write(getPasosNoMovidos() + " ");
		fichero.write(getPasosDados() + "");	
	}
}
