...
public class FoxHoundsSwingView extends FiniteRectBoardSwingView {
	
	private static final long serialVersionUID = 1L;

	/** Jugador de Ataxx */
	private FoxHoundsSwingPlayer player;
