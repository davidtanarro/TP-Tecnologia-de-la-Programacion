...
public class AtaxxMove extends GameMove {
	...
	public void execute(Board board, List<Piece> pieces) {
		...
		//Error: La posición destino está ocupada.
			...
			//Esa pieza no puede moverse a esa posición porque no está dentro de la distancia adecuada.
			if (dista > 2) {
	 ...
	 * @return Devuelve la máximo número para saber cuantas posiciones ha avanzado la pieza.
	 */
