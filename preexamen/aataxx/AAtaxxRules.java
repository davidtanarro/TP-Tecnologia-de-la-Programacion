...
public class AAtaxxRules implements GameRules {
	...
	public AAtaxxRules(int dimRows, int dimCols, int obs) {
	...
	public String gameDesc() {
		return "Advanced Ataxx " + fil + "x" + col;
	}
				...
				if (board.getPosition(i, j) == turn)
					for (int z = 0; z < maxPosi; z++) {
						...
						if (posCorrecta(nf, nc, board) && board.getPosition(nf, nc) == null)
							list.add(new AAtaxxMove(i, j, turn));
					}
		return list;
	}
