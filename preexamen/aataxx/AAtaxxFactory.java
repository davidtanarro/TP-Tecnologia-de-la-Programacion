...
public class AAtaxxFactory implements GameFactory {
	 ...
	 */
	public AAtaxxFactory(int dimRows, int dimCols) {
	 ...
	 */
	public AAtaxxFactory(int dimRows, int dimCols, int obs) {
	...
	public GameRules gameRules() {
		return new AAtaxxRules(this.fil, this.col, this.obs);
	}

	@Override
	public Player createConsolePlayer() {
		ArrayList<GameMove> possibleMoves = new ArrayList<GameMove>();
		possibleMoves.add(new AAtaxxMove());
